...
import { X, Upload, Edit, Tag } from "lucide-react";
...
const EditSubCategoryPopup = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-auto border border-slate-200 animate-in slide-in-from-bottom-4 duration-300">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 gap-2 max-h-32 overflow-y-auto p-3 bg-slate-50 rounded-xl border border-slate-200">
